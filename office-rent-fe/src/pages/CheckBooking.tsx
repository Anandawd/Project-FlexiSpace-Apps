      ...
      >
        ...
        >
          ...
          <button
            disabled={isLoading}
            type="submit"
            className="flex items-center justify-center rounded-full p-[12px_30px] gap-3 bg-[#4E91FC] font-bold text-[#F7F7FD]"
          >
              ...
              <div className="flex flex-col gap-5">
                {bookingDetails.is_paid ? (
                  <div className="flex items-center justify-between">
                    ...
                    <p className="rounded-full w-fit p-[6px_16px] bg-[#4E91FC] font-bold text-sm leading-[21px] text-[#F7F7FD]">
                      SUCCESS
                    </p>
                  </div>
                ) : (
